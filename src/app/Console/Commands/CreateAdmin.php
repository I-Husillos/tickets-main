...
class CreateAdmin extends Command
{
     ...
     * @var string
     */
    protected $signature = 'admin:create {name? : El nombre del administrador} {email? : El correo electrónico del administrador} {password? : La contraseña del administrador}';
